...
export const DEMO_TOUR_STEPS: DemoTourStep[] = [
  {
    ...
    body: "India's AI-powered vehicle companion — one app for buying, registering, maintaining, insuring, and selling or scrapping.",
    script: "Meet Vaahan Saarthi — India's AI-powered vehicle companion. One app for your entire vehicle journey.",
    audience: "guest",
    placement: "right",
    autoplaySec: 8,
  },
