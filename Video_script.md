...
**Live URL:** [https://vahaansaarthi.vercel.app/](https://vahaansaarthi.vercel.app/)
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **0:00–0:08** | **Browser — Login page** (`/`). Show the Vaahan Saarthi logo and tagline.                                                                        | "**Vaahan Saarthi** — India's AI vehicle companion. One app for the full ownership journey: buy, register, maintain, insure, and when the time comes, sell or scrap." |
...
**Live:** [https://vahaansaarthi.vercel.app/](https://vahaansaarthi.vercel.app/) · **Demo:** `himanshu@example.com` / `demo123`